                            ...
                            <c:forEach items="${users}" var="user">
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <button type="button" class="btn bg-olive btn-xs" onclick='location.href="user/findById?id=${user.id}"'>详情</button>
                                        <button type="button" class="btn bg-olive btn-xs" onclick='location.href="user/findUserByIdAndOtherRole?id=${user.id}"'>添加角色</button>
                        ...
                        <div class="pull-right">
                            <div class="form-group form-inline">
                                <div class="btn-group">
                                    ...
                                    <button type="submit" class="btn btn-default" title="删除" onclick='confirm("你确认要删除吗？")'><i class="fa fa-trash-o"></i> 删除</button>
